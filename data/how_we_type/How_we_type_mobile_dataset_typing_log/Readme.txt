...
Typing log data: 
	...
	layout: string,
	the sequence of the keys on the keyboard.

	message: string,
	text shown in the text area at the moment.

        touchx, touchy: float
	the coordinates of the touchpoints.
	...
